...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            "inline-flex h-10 items-center justify-start gap-8 rounded-md bg-transparent p-1 text-gray-500 border-b border-gray-200 w-full",
            className
        )}
        {...props}
    />
