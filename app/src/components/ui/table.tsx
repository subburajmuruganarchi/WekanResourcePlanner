...
>(({ className, ...props }, ref) => (
    <th
        ref={ref}
        className={cn(
            "h-10 px-4 py-3 text-left align-middle font-medium text-muted-foreground uppercase tracking-wider text-xs",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <td
        ref={ref}
        className={cn("p-4 align-middle [&:has([role=checkbox])]:pr-0 font-medium text-foreground", className)}
        {...props}
    />
))
