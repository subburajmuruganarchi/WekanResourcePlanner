    ...
    [ROLES.DELIVERY_MANAGER]: [
        {
            ...
            items: [
                ...
                { label: 'Weekly Planner', path: '/delivery/weekly-planner', icon: CalendarRange, roles: [ROLES.DELIVERY_MANAGER] },
                { label: 'Capacity Focus', path: '/delivery/capacity', icon: TrendingUp, roles: [ROLES.DELIVERY_MANAGER] },
    ...
    [ROLES.PROJECT_MANAGER]: [
        {
            ...
            items: [
                ...
                { label: 'Resource Allocation', path: '/allocation', icon: Users, roles: [ROLES.PROJECT_MANAGER] },
                { label: 'Weekly Planner', path: '/weekly-planner', icon: CalendarRange, roles: [ROLES.PROJECT_MANAGER] },
    ...
    [ROLES.EMPLOYEE]: [
        {
            ...
            items: [
                ...
                { label: 'Weekly Planner', path: '/weekly-planner', icon: CalendarRange, roles: [ROLES.EMPLOYEE, ROLES.USER] },
...
export const ROUTE_ACCESS: Record<string, SystemRoleName[] | '*'> = {
    ...
    '/delivery/weekly-planner': [ROLES.DELIVERY_MANAGER, ROLES.ADMIN],
    ...
    '/weekly-planner': [ROLES.ADMIN, ROLES.PROJECT_MANAGER, ROLES.CEO, ROLES.DELIVERY_MANAGER, ROLES.EMPLOYEE, ROLES.USER],
    '/time-entry': [ROLES.EMPLOYEE, ROLES.USER, ROLES.ADMIN, ROLES.PROJECT_MANAGER, ROLES.DELIVERY_MANAGER],
    '/pm-approvals': [ROLES.PROJECT_MANAGER, ROLES.DELIVERY_MANAGER],
...
export const ROUTE_TITLES: Record<string, { title: string; breadcrumb: string[] }> = {
    ...
    '/delivery/capacity': { title: 'Capacity Focus', breadcrumb: ['Delivery', 'Capacity'] },
    '/delivery/weekly-planner': { title: 'Weekly Planner', breadcrumb: ['Delivery', 'Weekly Planner'] },
