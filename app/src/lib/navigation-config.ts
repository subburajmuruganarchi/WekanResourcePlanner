    ...
    [ROLES.DELIVERY_MANAGER]: [
        {
            ...
            items: [
                ...
                { label: 'AI Recommendations', path: '/delivery/recommendations', icon: Sparkles, roles: [ROLES.DELIVERY_MANAGER] },
            ],
        },
    ],
...
export const ROUTE_TITLES: Record<string, { title: string; breadcrumb: string[] }> = {
    ...
    '/delivery/recommendations': { title: 'AI Recommendations', breadcrumb: ['Delivery', 'AI'] },
    ...
    '/pm/status-report': { title: 'Status Report', breadcrumb: ['Project', 'Status'] },
