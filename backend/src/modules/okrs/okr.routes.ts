...
// GET /api/okrs — list all OKRs (any authenticated role)
router.get('/', okrController.list);

// GET /api/okrs/periods — list available periods for dropdown
router.get('/periods', okrController.listPeriods);

// GET /api/okrs/employee/:employeeId — get OKRs for a specific employee
router.get('/employee/:employeeId', okrController.getByEmployee);
